...
#    RegisterCosem(OBISCode(0, 0, 96, 1, 0), MeterDataPointTypes.METERID.value),
    ...
    RegisterCosem(OBISCode(1, 1, 1, 8, 1), MeterDataPointTypes.ACTIVE_ENERGY_P_T1.value),
    RegisterCosem(OBISCode(1, 1, 1, 8, 2), MeterDataPointTypes.ACTIVE_ENERGY_P_T2.value),
    RegisterCosem(OBISCode(1, 1, 2, 8, 0), MeterDataPointTypes.ACTIVE_ENERGY_N.value),
    RegisterCosem(OBISCode(1, 1, 2, 8, 1), MeterDataPointTypes.ACTIVE_ENERGY_N_T1.value),
    RegisterCosem(OBISCode(1, 1, 2, 8, 2), MeterDataPointTypes.ACTIVE_ENERGY_N_T2.value),
    RegisterCosem(OBISCode(1, 1, 3, 8, 0), MeterDataPointTypes.REACTIVE_ENERGY_P.value),
    RegisterCosem(OBISCode(1, 1, 3, 8, 1), MeterDataPointTypes.REACTIVE_ENERGY_P_T1.value),
    RegisterCosem(OBISCode(1, 1, 3, 8, 2), MeterDataPointTypes.REACTIVE_ENERGY_P_T2.value),
    RegisterCosem(OBISCode(1, 1, 4, 8, 0), MeterDataPointTypes.REACTIVE_ENERGY_N.value),
    RegisterCosem(OBISCode(1, 1, 4, 8, 1), MeterDataPointTypes.REACTIVE_ENERGY_N_T1.value),
    RegisterCosem(OBISCode(1, 1, 4, 8, 2), MeterDataPointTypes.REACTIVE_ENERGY_N_T2.value),

    RegisterCosem(OBISCode(1, 1, 5, 8, 0), MeterDataPointTypes.REACTIVE_ENERGY_Q1.value),
    RegisterCosem(OBISCode(1, 1, 5, 8, 1), MeterDataPointTypes.REACTIVE_ENERGY_Q1_T1.value),
    RegisterCosem(OBISCode(1, 1, 5, 8, 2), MeterDataPointTypes.REACTIVE_ENERGY_Q1_T2.value),

    RegisterCosem(OBISCode(1, 1, 6, 8, 0), MeterDataPointTypes.REACTIVE_ENERGY_Q2.value),
    RegisterCosem(OBISCode(1, 1, 6, 8, 1), MeterDataPointTypes.REACTIVE_ENERGY_Q2_T1.value),
    RegisterCosem(OBISCode(1, 1, 6, 8, 2), MeterDataPointTypes.REACTIVE_ENERGY_Q2_T2.value),

    RegisterCosem(OBISCode(1, 1, 7, 8, 0), MeterDataPointTypes.REACTIVE_ENERGY_Q3.value),
    RegisterCosem(OBISCode(1, 1, 7, 8, 1), MeterDataPointTypes.REACTIVE_ENERGY_Q3_T1.value),
    RegisterCosem(OBISCode(1, 1, 7, 8, 2), MeterDataPointTypes.REACTIVE_ENERGY_Q3_T2.value),

    RegisterCosem(OBISCode(1, 1, 8, 8, 0), MeterDataPointTypes.REACTIVE_ENERGY_Q4.value),
    RegisterCosem(OBISCode(1, 1, 8, 8, 1), MeterDataPointTypes.REACTIVE_ENERGY_Q4_T1.value),
    RegisterCosem(OBISCode(1, 1, 8, 8, 2), MeterDataPointTypes.REACTIVE_ENERGY_Q4_T2.value),
]
